...
\title{Puissances entières, unités SI et symboles chimiques}
...
Le nombre d'Avogadro est historiquement défini comme le nombre d'atomes de \ce{^12_6C} dans \qty{12}{g} de matière.
Sa valeur était approximativement de:
\[
...
Avec :
\begin{itemize}
    \item \(Z\) est le numéro atomique, qui correspond au nombre de protons dans le noyau de l'atome.
    \item \(A\) est le numéro de masse, qui correspond au nombre total de protons et de neutrons (les nucléons) dans le noyau.
    \item \(X\) est le symbole de l'élément.
\end{itemize}
\smallskip
\textbf{Exemple}
...
\]
\begin{itemize}
    \item \(Z = 6\) : il y a 6 protons dans le noyau.
    \item \(A = 12\) : il y a 6 neutrons (12 - 6 = 6).
    \item \(X = C\) : symbole du carbone.
\end{itemize}
...
\begin{itemize}
    \item Le "protium" (isotope le plus commun, généralement juste appelé "hydrogène" ou "proton") : \ce{^1_1H}
    \item Le deutérium : \ce{^2_1H}
    \item Le tritium : \ce{^3_1H}
\end{itemize}
\smallskip
